...
import '../../../instructor/services/auth_service.dart';

class GroupService {
  static const String baseUrl = 'http://54.82.53.11:5001/api';

  // Get all groups for the instructor
  static Future<Map<String, dynamic>> getInstructorGroups(page, limit) async {
    try {
      ...
      final response = await InstructorAuthService.authenticatedRequest(
        method: 'GET',
        url: '$baseUrl/groups/?page=$page&limit=$limit',
      );
