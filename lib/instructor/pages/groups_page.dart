...
import 'package:fluttertest/instructor/utils/scroll_utils.dart'; // Keep this for json.encode in _showCreateGroupDialog

class GroupsPage extends StatefulWidget {
  final bool isInDashboard;

  const GroupsPage({super.key, this.isInDashboard = false});
...
class _GroupsPageState extends State<GroupsPage> {
  ...
  Future<void> _fetchGroups() async {
    ...
    try {
      ...
      // Debug logs
      print('Groups fetch result: $result');
  ...
  // Removed sample groups as we now use real API data
            ...
            child: _isLoading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // Get the member count, checking all possible paths in the API response
                      int members = 0;
...
class _GroupDetailPageState extends State<GroupDetailPage> {
  ...
  // This function is now removed as we're directly using GroupService.findStudentByEmail
                      ...
                      Container(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            _socketService
                                .dispose(); // This returns void, no need for await
