...
class _PopularCoursesPageState extends State<PopularCoursesPage> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to load popular courses: $e'),
  ...
  Future<void> _toggleFavorite(Course course) async {
    ...
    try {
      debugPrint('🔄 Attempting to toggle favorite for course: ${course.id}');
      final success = await _favoritesService.toggleFavorite(course);
      
      debugPrint('📊 Toggle result: $success');
      debugPrint('❌ Error: ${_favoritesService.error}');
      ...
      debugPrint('❌ Exception in _toggleFavorite: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
